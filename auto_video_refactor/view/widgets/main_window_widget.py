...
from auto_video_refactor.view.widgets.push_button_widget import PushButtonWidget
from auto_video_refactor.controller.autosuggest import autosuggest_video_title
from auto_video_refactor.view.widgets.line_edit_widget import LineEditWidget
from auto_video_refactor.view.widgets.tree_widget import TreeWidget
from auto_video_refactor.common import ICONS_DIR
from PySide6.QtCore import QSize, Qt
from PySide6.QtGui import QIcon

import auto_video_refactor.model.file_system_tree as fstree
import sys
import os

try:
    from ctypes import windll  # Only exists on Windows.
    myappid = 'auto-video-refactor'
...
class MainWindow(QMainWindow):
    def __init__(self, app):
        ...
        self.app = app
        self.setWindowTitle("Auto Video Refactor")
